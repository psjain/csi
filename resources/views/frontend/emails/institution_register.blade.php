...
<h3 style="font-size: 20px; color: #3f5586;float:left;">Successful submission of Application for CSI Institutional membership!</h3>
<div style="min-height:70px;"></div>
<p style="padding: 5px 20px;font-weight: 300;font-size: 13px;">Dear {{$name}},</p>
<p style="padding: 5px 20px;font-weight: 300;font-size: 13px;">Your application for <strong>Institutional Membership</strong> of <strong>Computer Society of India (CSI)</strong> has been received successfully.</p>
